...
public final class StartStreamingUseCase: Sendable {
    ...
    // Stop Sharing in the system capture indicator is an explicit end of session, not a
    // broken stream: the server must come down (audio included) and offer Start again.
